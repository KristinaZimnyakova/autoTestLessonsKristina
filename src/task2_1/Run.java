...
public class Run {
    public static void main(String[] args){
        ...
        Animal.reproduction(tiger1, tiger2, isAliveTiger1, isAliveTiger2);
        ...
        Animal.reproduction(rabbit1, rabbit2, isAliveRabbit1, isAliveRabbit2);

        Animal.reproduction(tiger1, rabbit2, isAliveTiger1, isAliveRabbit2);
